...
{
    public partial class GisHeadCount
    {
        public double? RowWid { get; set; }
        ...
        public double? SupervisorId { get; set; }
        public string SupervisorNm { get; set; }
        public double? OrganizationCd { get; set; }
        ...
        public double? DatasourceNumId { get; set; }
